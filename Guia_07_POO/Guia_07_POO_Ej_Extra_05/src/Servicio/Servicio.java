...
public class Servicio {
    ...
    public void obtenerMes(Meses m) {

        String mes;
        System.out.println("Adivine el mes secreto: ");
        System.out.println("Ingrese un numero del 1 al 12");
        do {
            mes = m.getMeses()[leer.nextInt() - 1];
            if (mes.equals(m.getMeses()[8])) {
                System.out.println("No ha acertado. Intente adivinarlo introduciendo otro mes: ");
            }
        } while (!mes.equals(m.getMeses()[8]));
        System.out.println("Correcto! ha ganado, acertó el mes secreto, y este es Septiembre.");
    }
}
